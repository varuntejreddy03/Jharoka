    ...
    return (
      <div className="bg-jharoka-cream min-h-screen">
        ...
        <main className="pt-32 text-center">
          <h1 className="font-serif text-4xl text-jharoka-burgundy-900">Product not found</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-7 flex flex-col gap-6">
            <motion.div
              ...
              className="relative aspect-[4/5] lg:aspect-[16/11] w-full overflow-hidden rounded-sm bg-white group cursor-crosshair border border-jharoka-burgundy/10"
            ...
            >
              ...
              />
              <div className="absolute inset-0 flex items-center justify-center bg-jharoka-cream-dim -z-10">
                <div className="w-32 h-32 rounded-full bg-jharoka-burgundy/10 flex items-center justify-center">
                  <span className="text-5xl text-jharoka-burgundy/30">
            ...
            >
              {product.images.map((img, idx) => (
                <button
                  ...
                  className={`relative w-24 h-24 lg:w-32 lg:h-32 flex-shrink-0 rounded-sm overflow-hidden transition-all duration-300 bg-white border ${activeImageIndex === idx ? 'ring-2 ring-jharoka-burgundy opacity-100 border-jharoka-burgundy' : 'opacity-70 hover:opacity-100 border-jharoka-burgundy/10'}`}
                >
                  <Image 
                    src={img} 
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center bg-jharoka-cream-dim -z-10">
                    <span className="text-lg text-jharoka-burgundy/40">{idx + 1}</span>
                  </div>
                </button>
              ))}
            </motion.div>
            ...
            <div className="hidden lg:block mt-12 space-y-16">
              <div className="grid grid-cols-2 gap-8 border-t border-jharoka-burgundy/10 pt-12">
                <div className="space-y-4">
                  ...
                  <p className="text-jharoka-burgundy-900/70 text-sm leading-relaxed">
                    Every curve and joint is hand-finished by master artisans, ensuring a piece that transcends time.
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="w-10 h-10 rounded-full bg-jharoka-cream-dim flex items-center justify-center text-jharoka-burgundy">
              ...
              <div className="border-t border-jharoka-burgundy/10 pt-12">
                ...
                <div className="bg-white p-8 rounded-sm grid grid-cols-1 md:grid-cols-2 gap-8 shadow-[0_2px_20px_-10px_rgba(0,0,0,0.05)] border border-jharoka-burgundy/5">
                  <div>
            ...
            <div className="lg:sticky lg:top-32 space-y-10">
              ...
              <div className="lg:hidden mt-12 space-y-12 block">
                <div className="pt-8 border-t border-jharoka-burgundy/10">
                  ...
                  <div className="bg-white p-6 rounded-sm border border-jharoka-burgundy/5">
